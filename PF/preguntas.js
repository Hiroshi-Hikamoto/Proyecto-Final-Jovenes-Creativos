...
function cargarPregunta(index) {
  ...
  document.getElementById("option1").innerHTML = opciones[0];
  document.getElementById("option2").innerHTML = opciones[1];
  document.getElementById("option3").innerHTML = opciones[2];
  document.getElementById("option4").innerHTML = opciones[3];
}
